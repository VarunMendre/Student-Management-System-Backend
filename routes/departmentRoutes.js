...
router.get("/", authorizeRoles("principal", "accountant", "admin", "student"), getAllDepartments);
router.get("/:id", authorizeRoles("principal", "accountant", "admin", "student"), validate(departmentSchemas.byId), getDepartmentById);
